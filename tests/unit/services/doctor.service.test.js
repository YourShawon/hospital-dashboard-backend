...
const ApiError_1 = require("../../../src/common/utils/ApiError");
...
const doctor_service_1 = require("../../../src/modules/doctor/doctor.service");
describe("DoctorService - addDoctor", () => {
    ...
    it("should create a new doctor successfully", async () => {
        ...
        const result = await doctor_service_1.DoctorService.addDoctor(validDoctorData);
    ...
    it("should throw ApiError when doctor email already exists", async () => {
        ...
        await expect(doctor_service_1.DoctorService.addDoctor(validDoctorData)).rejects.toThrow(ApiError_1.ApiError);
        await expect(doctor_service_1.DoctorService.addDoctor(validDoctorData)).rejects.toThrow("Doctor already exists");
        expect(mockFindByEmail).toHaveBeenCalledWith(validDoctorData.email);
    ...
    it("should propagate repository errors", async () => {
        ...
        await expect(doctor_service_1.DoctorService.addDoctor(validDoctorData)).rejects.toThrow("Database connection failed");
    });
});
